Create_Reconstruction_Files <- function(SitesTable,EvolutionModel,Method,Phylogeny,OrthoPath) {
  ...
  for (ORTH in 1:length(Sites[,1])){
    ...
    Alignment =paste0(OrthoPath,Sites[ORTH,1],".codon.alg.fasta.phy")
    ...
    write.table(FASTA,file=paste0(OrthoPath,Sites[ORTH,1],'.recons.fasta'),sep="\t",row.names = FALSE,col.names = FALSE,quote = FALSE)
    #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
