	...
	Nodes.Edges <- Create_Transition_Table_No_Fit(SitesTable = "/home/lalibelulalo/TESIS/Clados/Calothrix_B/PALINDROMES/TGGCGCCA/PCC_7716/Orthologues_Palindrome_sites.txt",
		                        EvolutionModel = "F81",
		                        Method = "bayes",
