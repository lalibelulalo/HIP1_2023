...
# USE:
# time sh PipeLine_ASR.sh Calothrix_sp_NIES-4071 GCGATCGC /home/lalibelulalo/TESIS/Clados/Calothrix_B/gbff_homologues/CalothrixspNIES-3974NIES-3974_f0_0taxa_algOMCL_e0_ Calothrix_B 7
...
echo -n "\rObteniendo ortólogos con sitios $SppB *"
mkdir $SppB
