	...
	Create_Reconstruction_Files(SitesTable = "/home/lalibelulalo/TESIS/Clados/Calothrix_B/PALINDROMES/GCGATCGC/NIES-4071/Orthologues_Palindrome_sites.AllFrames.FIRST.txt",
		                    EvolutionModel = "F81",
		                    Method ="bayes",
