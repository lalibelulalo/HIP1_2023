	...
	Nodes.Edges <- Create_Transition_Table_No_Fit(SitesTable = "/home/lalibelulalo/TESIS/Clados/Calothrix_B/PALINDROMES/GCGATCGC/NIES-267/Orthologues_Palindrome_sites.txt",
		                        EvolutionModel = "F81",
		                        Method = "bayes",
