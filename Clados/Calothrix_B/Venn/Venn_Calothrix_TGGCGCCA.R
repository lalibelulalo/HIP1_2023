...
for(i in 1:length(Spps)){
  File <- read.table(paste0("/home/lalibelulalo/HIP1_2023/Clados/",Clado,"/PALINDROMES/TGGCGCCA/",Spps[i],"/Orthologues_Palindrome_sites.AllFrames.FIRST.txt"),
                     sep = "\t",
                     header = TRUE)
  File <- File%>%
    filter(Spp==Spps[i])
...
ggplot2::ggsave(p,file=paste0("/home/lalibelulalo/HIP1_2023/Clados/",Clado,"/Venn/Venn_",Clado,"-TGGCGCCA-",length(Spps2),".png"),width=7, height=6, units="in", scale=1.5)
...
ggplot2::ggsave(p2,file=paste0("/home/lalibelulalo/HIP1_2023/Clados/",Clado,"/Venn/Venn_",Clado,"-TGGCGCCA-2-",length(Spps2),"RELEVANT.png"),width=7, height=7, units="in", scale=1.5)
