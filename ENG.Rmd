...
```{r FIG3, echo=FALSE, fig.cap='**Conjuntos de sitios.** En esta figura podemos ver los 4 conjuntos de sitios de acuerdo a la especie de referencia.', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r FIG4, echo=FALSE, fig.cap='**Conjuntos de sitios.** En esta figura podemos ver los 4 conjuntos de sitios de acuerdo a la especie de referencia.', out.width='100%', fig.asp=.75, fig.align='center'}
