...
knitr::include_graphics(normalizePath('/home/lalibelulalo/HIP1_2023/Clados/Calothrix_B/figures/A/GCGATCGC/All/336-3_All_A_tree.png'))
```

```{r FIG14x, echo=FALSE, fig.cap='**Conjuntos de sitios de la especie NIES-3974 en el conjunto ALL.** En esta figura podemos ver la filogenia anotada para los sitios de la especie NIES-3974, en cada nodo hay un diagrama de pie que muestra la proporcion de tipos de cambios en los aminoacidos que hubo en cada transición. Éstas proporciones se muestran para los tres marcos de lectura.', out.width='120%', fig.asp=.75, fig.align='center'}
knitr::include_graphics(normalizePath('/home/lalibelulalo/HIP1_2023/Clados/Calothrix_B/figures/A/GCGATCGC/All/NIES-3974_All_A_tree.png'))
```
...
knitr::include_graphics(normalizePath('/home/lalibelulalo/HIP1_2023/Clados/Calothrix_B/figures/A/GCGATCGC/All/PCC_6303_All_A_tree.png'))
```
...
knitr::include_graphics(normalizePath('/home/lalibelulalo/HIP1_2023/Clados/Calothrix_B/figures/A/GCGATCGC/All/SUBCLADE_All_A_tree.png'))
```
