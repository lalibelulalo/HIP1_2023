...
knitr::include_graphics("Clados/Calothrix_B/figures/Calothrix_B_Octanuc_FrecObs_sel32_filogenia_HIG.png")
```
...
source("ASR_Orth_Functions/NodeAndEdges.R")
Transition_table <- read.table("Clados/Calothrix_B/PALINDROMES/GCGATCGC/336-3/All_RF.TRANSICIONES.txt", sep = "\t", header = TRUE )
...
Tree = ggtree::read.tree("Clados/Calothrix_B/SpeciesTree_rooted.txt")
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,results='hide'}
Directed_Transition_table <- read.table("Clados/Calothrix_B/PALINDROMES/GCGATCGC/336-3/All_RF.TRANSICIONES_DIRECCION.txt", sep = "\t", header = TRUE )
...
File= "Clados/Calothrix_B/PALINDROMES/GCGATCGC/336-3/Orthologues_Palindrome_sites.AllFrames.SECOND.txt"
